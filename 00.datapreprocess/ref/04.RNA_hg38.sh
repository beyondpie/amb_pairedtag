...
current="/projects/ps-renlab2/zhw063/14.MouseBrainPTexp8_20230418"

###
fastq_dir="${current}/01.rawdata"
old_fastq_dir="${current}"
trim_dir="${current}/02.trimmed"
map_dir="${current}/03.hg38_mapping"
...
hg38_rna="/projects/ps-renlab/zhw063/software/Paired-Tag-master/references/hg38.RNA.txt"
...
hg38_STAR="/projects/ps-renlab/share/STAR_indices/hg38"
...
if [ $genome == "hg38" ]; then ref=${hg38_STAR}; gene=${hg38_rna}; gtf=${hg38_gtf}; STAR="/home/zhw063/ps-renlab/software/STAR-2.5.3a/bin/Linux_x86_64/STAR"; fi
