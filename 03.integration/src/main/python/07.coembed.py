...
si_pt = loadsi(model_path=si_pt_modelpath, adata_dict={0: ann_allen, 1: ann_pt})
si_snmC = loadsi(model_path=si_snmC_modelpath, adata_dict={0: ann_allen, 1: ann_snmC})
si_atac = loadsi(model_path=si_atac_modelpath, adata_dict={0: ann_allen, 1: ann_atac})
...
allen_pca = int_allen_pt[0]
pt_pca = int_allen_pt[1]
